    ...
    <>
      {info.map((item) => (
        <PageImagem
          key={item.step}
          id={item.step}
          text="Hypnozio pode ajudá-lo a controlar seus problemas de peso em apenas 15 minutos por dia. Você receberá um programa de hipnoterapia personalizado criado por Edward Miller com o objetivo de melhorar sua relação com a alimentação e atingir o peso desejado."
